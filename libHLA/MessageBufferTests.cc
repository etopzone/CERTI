...
void messageBufferTests(libhla::MessageBuffer& MsgBuf)
{
    ...
    assert(vd64 == d64);
    vtrueBool = MsgBuf.read_bool();
    assert(trueBool == vtrueBool);
    vfalseBool = MsgBuf.read_bool();
    assert(falseBool == vfalseBool);
    vstdstr = MsgBuf.read_string();
    assert(vstdstr == stdstr);
    ...
    assert(vu32 == u32);
    vu64 = MsgBuf.read_uint64();
    assert(vu64 == u64);
    vi8 = MsgBuf.read_int8();
    assert(vi8 == i8);
    vi16 = MsgBuf.read_int16();
    assert(vi16 == i16);
    vi32 = MsgBuf.read_int32();
    assert(vi32 == i32);
    vi64 = MsgBuf.read_int64();
    assert(vi64 == i64);
    vf32 = MsgBuf.read_float();
    assert(vf32 == f32);
    vd64 = MsgBuf.read_double();
    assert(vd64 == d64);
    cout << "    All encoded/decoded values are equal." << endl;
    cout << "    Now reset buffer." << endl;
    MsgBuf.reset();
    ...
    MsgBuf.write_uint8(u8);
    cout << "        Written <";
    libhla::MessageBuffer::show(&u8, 1);
    cout << ">" << endl;
    MsgBuf.write_uint16(u16);
    cout << "        Written <";
    libhla::MessageBuffer::show(&u16, 2);
    cout << ">" << endl;
    MsgBuf.write_uint32(u32);
    cout << "        Written <";
    libhla::MessageBuffer::show(&u32, 4);
    cout << ">" << endl;
    MsgBuf.write_uint64(u64);
    cout << "        Written <";
    libhla::MessageBuffer::show(&u64, 8);
    cout << ">" << endl;
    MsgBuf.write_int8(i8);
    cout << "        Written <";
    libhla::MessageBuffer::show(&i8, 1);
    cout << ">" << endl;
    MsgBuf.write_int16(i16);
    cout << "        Written <";
    libhla::MessageBuffer::show(&i16, 2);
    cout << ">" << endl;
    MsgBuf.write_int32(i32);
    cout << "        Written <";
    libhla::MessageBuffer::show(&i32, 4);
    cout << ">" << endl;
    MsgBuf.write_int64(i64);
    cout << "        Written <";
    libhla::MessageBuffer::show(&i64, 8);
    cout << ">" << endl;
    MsgBuf.write_float(f32);
    cout << "        Written <";
    libhla::MessageBuffer::show(&f32, 4);
    cout << ">" << endl;
    MsgBuf.write_double(d64);
    cout << "        Written <";
    libhla::MessageBuffer::show(&d64, 8);
    cout << ">" << endl;
    ...
    MsgBuf.read_uint8(&vu8);
    cout << "        Read  <";
    libhla::MessageBuffer::show(&vu8, 1);
    cout << ">" << endl;
    MsgBuf.read_uint16(&vu16);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vu16, 2);
    cout << ">" << endl;
    MsgBuf.read_uint32(&vu32);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vu32, 4);
    cout << ">" << endl;
    MsgBuf.read_uint64(&vu64);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vu64, 8);
    cout << ">" << endl;
    MsgBuf.read_int8(&vi8);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vi8, 1);
    cout << ">" << endl;
    MsgBuf.read_int16(&vi16);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vi16, 2);
    cout << ">" << endl;
    MsgBuf.read_int32(&vi32);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vi32, 4);
    cout << ">" << endl;
    MsgBuf.read_int64(&vi64);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vi64, 8);
    cout << ">" << endl;
    MsgBuf.read_float(&vf32);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vf32, 4);
    cout << ">" << endl;
    MsgBuf.read_double(&vd64);
    cout << "        Read <";
    libhla::MessageBuffer::show(&vd64, 8);
    cout << ">" << endl;
    delete[] vstr;
