...
void messageBufferTests(MsgBuffer_t* MsgBuf)
{
    ...
    assert(vd64 == d64);
    MB_read_bool(MsgBuf, &vtrueBool);
    assert(trueBool == vtrueBool);
    MB_read_bool(MsgBuf, &vfalseBool);
    ...
    assert(vu32 == u32);
    vu64 = MB_get_uint64(MsgBuf);
    assert(vu64 == u64);
    vi8 = MB_get_int8(MsgBuf);
    assert(vi8 == i8);
    vi16 = MB_get_int16(MsgBuf);
    assert(vi16 == i16);
    vi32 = MB_get_int32(MsgBuf);
    assert(vi32 == i32);
    vi64 = MB_get_int64(MsgBuf);
    assert(vi64 == i64);
    vf32 = MB_get_float(MsgBuf);
    assert(vf32 == f32);
    vd64 = MB_get_double(MsgBuf);
    assert(vd64 == d64);
    printf("    All encoded/decoded values are equal.\n");
    printf("    Now reset buffer.\n");
    MB_reset(MsgBuf);
    ...
    vu32 = MB_get_uint32(&MsgBuf2);
    assert(vu32 == u32);
    vu8 = MB_get_uint8(&MsgBuf2);
    assert(vu8 == u8);
    vu16 = MB_get_uint16(&MsgBuf2);
    assert(vu16 == u16);
    MB_destroy(&MsgBuf2);
