...
// TODO cvannier: move to a google test suite
...
#define FIELD_A 0
        HLAfixedField<FIELD_A,
                      HLAoctet,
#define FIELD_B 1
                      HLAfixedField<FIELD_B,
                                    HLAboolean,
#define FIELD_C 2
    ...
    const char* correct = "0000:  41 00 00 00 00 00 00 01 40 09 1e b8 51 eb 85 1f\n";
...
#define FIELD_B 1
    ...
    const char* correct = "0000:  00 00 00 00 30 00 00 00 00 00 00 2a 31\n";
...
int test4()
{
    ...
    const char* correct = "0000:  00 00 00 01 00 00 00 00 40 09 1e b8 51 eb 85 1f\n";
...
int test5()
{
    typedef HLAvariableArray<HLAfixedRecord<
#define FIELD_A 0
        HLAfixedField<FIELD_A,
                      HLAvariableArray<HLAfloat64LE>,
#define FIELD_B 1
    ...
    const char* correct = "0000:  00 00 00 01 00 00 00 00 00 00 00 02 00 00 00 00\n"
...
int test6()
{
    ...
    *A = "UFO";
    ...
    const char* correct = "0000:  00 00 00 03 55 46 4f\n";
