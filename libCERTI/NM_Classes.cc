...
std::ostream& NM_Update_Attribute_Values::show(std::ostream& out)
{
    ...
    out << std::endl;
    out << "(opt) event ="
        << "      //FIXME FIXME don't know how to serialize native field <event> of type <EventRetractionHandle>"
        << std::endl;
...
std::ostream& NM_Message_Null_Prime::show(std::ostream& out)
{
    ...
    //Specific show code
    out << " timestamp = "
        << "      //FIXME FIXME don't know how to serialize native field <timestamp> of type <FederationTime>"
        << std::endl;
...
std::ostream& New_NetworkMessage::show(std::ostream& out)
{
    ...
    out << "(opt) date ="
        << "      //FIXME FIXME don't know how to serialize native field <date> of type <FederationTime>" << std::endl;
