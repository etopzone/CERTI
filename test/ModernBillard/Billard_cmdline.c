/*
  ...
  gengetopt --no-handle-error --show-required -i CommandLine.ggo -F Billard_cmdline -G
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVa:cd:ef:l:n:o:t:vx:y:X:Y:F:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'c':	/* coordinated time.  */
          ...
          if (update_arg((void *)&(args_info->coordinated_flag), 0, &(args_info->coordinated_given),
        ...
        case 'e':	/* no timestamp.  */
          ...
          if (update_arg((void *)&(args_info->notimestamp_flag), 0, &(args_info->notimestamp_given),
