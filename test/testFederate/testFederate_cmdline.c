/*
  ...
  /usr/bin/gengetopt --no-handle-error --show-required -i /home/erk/workspace/certi/test/testFederate/testFederate.ggo -F testFederate_cmdline -G
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --federation-name=STRING  federation name to be joined by the federate\n                                  (default=`testFederation')",
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->federation_name_given)
    write_into_file(outfile, "federation-name", args_info->federation_name_orig, 0);
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVv:n:f:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* federation name to be joined by the federate.  */
          ...
          if (update_arg( (void *)&(args_info->federation_name_arg), 
               &(args_info->federation_name_orig), &(args_info->federation_name_given),
              &(local_args_info.federation_name_given), optarg, 0, "testFederation", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "federation-name", 'f',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "fom-model") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->fom_model_arg), 
                ...
                &(local_args_info.fom_model_given), optarg, 0, "testFederation.fed", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "fom-model", '-',
                additional_error))
              goto failure;
