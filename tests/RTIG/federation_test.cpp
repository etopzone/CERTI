...
{
    auto fed = f.add("fed", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
{
    f.add("fed", "typeerate", {}, ::certi::HLA_1_3, nullptr, 0, 0);

    ASSERT_THROW(f.add("fed", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0), ::certi::FederateAlreadyExecutionMember);
...
{
    auto responses = f.add("fed", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).second;
...
{
    auto fed = f.add("regul1", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
{
    f.registerSynchronization(f.add("sync_emitter", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first, "label", "tag");
...
{
    auto fed = f.add("new", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
{
    f.add("fed", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0);
...
{
    f.add("fed1", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0);

    f.add("fed2", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0);

    f.add("fed3", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0);
...
{
    ASSERT_TRUE(f.check(f.add("fed", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first));
}
...
{
    auto handle1 = f.add("fed1", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
    auto handle2 = f.add("fed2", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
{
    auto handle = f.add("fed", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
{
    auto handle = f.add("regulator", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
TEST_F(FederationTest, RegisterSynchronizationAddsLabelToAllFederates)
{
    ...
    auto& fed1 = f.getFederate(f.add("fed 1", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first);
    auto& fed2 = f.getFederate(f.add("fed 2", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first);
    auto& fed3 = f.getFederate(f.add("fed 3", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first);
...
{
    auto handle = f.add("emitter", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
TEST_F(FederationTest, RegisterSynchronizationPerSetAddsLabelToSpecifiedFederates)
{
    ...
    auto h1 = f.add("fed 1", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
    auto h2 = f.add("fed 2", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
    auto h3 = f.add("fed 3", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0).first;
...
TEST_F(FederationTest, UnregisterSynchronizationRemovesSyncLabelFromFederate)
{
    ...
    f.add("other_fed", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0);
...
TEST_F(FederationTest, FederateSaveStatusUpdatesFlagAndUnderlyingFederate)
{
    ...
    f.add("other", fed_type, {}, ::certi::HLA_1_3, nullptr, 0, 0); // to return early
