...
ObjectHandle FederationsList::registerObject(Handle federationHandle,
                                             ...
                                             ObjectName_t name) throw(FederationExecutionDoesNotExist,
...
bool FederationsList::isOwner(Handle federationHandle,
                              FederateHandle federate,
                              ObjectHandle id,
                              AttributeHandle attribute) throw(FederationExecutionDoesNotExist,
                                                               FederateNotExecutionMember,
                                                               ObjectNotKnown,
                                                               AttributeNotDefined,
                                                               SaveInProgress,
...
void FederationsList::acquireIfAvailable(Handle federationHandle,
                                         ...
                                         ObjectHandle id,
                                         const std::vector<AttributeHandle>& attributes,
                                         uint16_t list_size) throw(FederationExecutionDoesNotExist,
                                                                   ObjectNotKnown,
                                                                   ObjectClassNotPublished,
                                                                   AttributeNotDefined,
...
long FederationsList::createRegion(Handle federationHandle,
                                   FederateHandle federate,
                                   SpaceHandle space,
                                   long nb_extents) throw(FederationExecutionDoesNotExist,
                                                          SpaceNotDefined,
                                                          InvalidExtents,
                                                          FederateNotExecutionMember,
                                                          SaveInProgress,
...
void FederationsList::modifyRegion(Handle federationHandle,
                                   FederateHandle federate,
                                   RegionHandle region,
                                   const std::vector<Extent>& extents) throw(FederationExecutionDoesNotExist,
                                                                             InvalidExtents,
                                                                             SaveInProgress,
                                                                             RestoreInProgress,
                                                                             RTIinternalError)
...
void FederationsList::deleteRegion(Handle federationHandle,
                                   FederateHandle federate,
                                   long region) throw(FederationExecutionDoesNotExist,
                                                      RegionNotKnown,
                                                      RegionInUse,
                                                      FederateNotExecutionMember,
                                                      SaveInProgress,
...
void FederationsList::associateRegion(
    Handle federationHandle,
    FederateHandle federate,
    ObjectHandle object,
    RegionHandle region,
    unsigned short nb_attributes,
    const std::vector<AttributeHandle>& attributes) throw(FederationExecutionDoesNotExist,
                                                          RegionInUse,
                                                          FederateNotExecutionMember,
                                                          SaveInProgress,
                                                          RestoreInProgress,
...
void FederationsList::unassociateRegion(Handle federationHandle,
                                        FederateHandle federate,
                                        ObjectHandle object,
                                        RegionHandle region) throw(FederationExecutionDoesNotExist,
                                                                   RegionInUse,
                                                                   FederateNotExecutionMember,
                                                                   SaveInProgress,
                                                                   RestoreInProgress,
...
ObjectHandle FederationsList::registerObjectWithRegion(
    Handle federationHandle,
    FederateHandle federate,
    ...
    RegionHandle region,
    int nb,
    const std::vector<AttributeHandle>& attrs) throw(FederationExecutionDoesNotExist,
                                                     ObjectClassNotDefined,
                                                     ObjectClassNotPublished,
                                                     AttributeNotDefined,
                                                     AttributeNotPublished,
