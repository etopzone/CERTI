/*
  ...
  /usr/bin/gengetopt --no-handle-error --show-required -i /home/erk/workspace/certi/RTIG/RTIG.ggo -F RTIG_cmdline -G
...
const char *gengetopt_args_info_purpose = "CERTI RunTime Infrastructure Gateway (RTIG)";
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVv:l:", long_options, &option_index);
