...
struct gengetopt_args_info
{
  ...
  char * listen_orig;	/**< @brief listen only on specified IP address original value given at command line.  */
  const char *listen_help; /**< @brief listen only on specified IP address help description.  */
