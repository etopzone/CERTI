                                                                               ...
                                                                               RTIinternalError)
{
    ...
    if (e == Exception::Type::NO_EXCEPTION) {
        ...
        std::unique_ptr<NetworkMessage> reponse(
            comm->waitMessage(NetworkMessage::Type::CREATE_FEDERATION_EXECUTION, federate));
...
void FederationManagement::destroyFederationExecution(const std::string& theName, Exception::Type& e)
{
    ...
    if (e == Exception::Type::NO_EXCEPTION) {
        ...
        std::unique_ptr<NetworkMessage> reponse(
            comm->waitMessage(NetworkMessage::Type::DESTROY_FEDERATION_EXECUTION, federate));
...
void FederationManagement::resignFederationExecution(ResignAction, Exception::Type& e)
{
    ...
    if (e == Exception::Type::NO_EXCEPTION) {
        ...
        std::unique_ptr<NetworkMessage> reponse(
            comm->waitMessage(NetworkMessage::Type::RESIGN_FEDERATION_EXECUTION, federate));
                                                 ...
                                                 Exception::Type& /*e*/)
{
    ...
    G.Out(pdGendoc,
          "enter FederationManagement::requestFederationSave "
          "with time");
...
void FederationManagement::requestFederationSave(const std::string& label, Exception::Type& /*e*/)
{
    ...
    G.Out(pdGendoc,
          "exit  FederationManagement::requestFederationSave "
          "without time");
}
                                                          ...
                                                          const std::string& reason)
{
    ...
    D.Out(pdInit, "Federation restore request %saccepted", status ? "" : "not ");
...
void FederationManagement::initiateFederateRestore(const std::string& label, FederateHandle handle)
{
    ...
    D.Out(pdInit, "Initiate federate restore \"%s\" with federate handle %d.", label.c_str(), handle);
