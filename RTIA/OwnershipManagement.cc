...
OwnershipManagement::attributeOwnedByFederate(ObjectHandle theObject, AttributeHandle theAttribute, Exception::Type& e)
{
    ...
    D.Out(pdDebug, "Federate %u ", fm->my_federate_handle);
...

{
    ...
    D.Out(pdDebug, "NEGOTIATED_DIVESTITURE Federate %u ", fm->my_federate_handle);
                                                                        ...
                                                                        Exception::Type& e)
{
    ...
    D.Out(pdDebug, "CANCEL_NEGOTIATED_DIVESTITURE Federate %u ", fm->my_federate_handle);
                                                                   ...
                                                                   Exception::Type& e)
{
    ...
    D.Out(pdDebug, "AcquisitionIfAvailable Federate %u ", fm->my_federate_handle);
                                                                     ...
                                                                     Exception::Type& e)
{
    ...
    D.Out(pdDebug, "UNCONDITIONAL_DIVESTITURE Federate %u ", fm->my_federate_handle);
                                                        ...
                                                        Exception::Type& e)
{
    ...
    D.Out(pdDebug, "OWNERSHIP_ACQUISITION Federate %u ", fm->my_federate_handle);
                                                              ...
                                                              Exception::Type& e)
{
    ...
    D.Out(pdDebug, "CANCEL_ACQUISITION Federate %u ", fm->my_federate_handle);
