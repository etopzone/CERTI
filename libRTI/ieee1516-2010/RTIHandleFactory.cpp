...
#define DECLARE_HANDLE_FRIEND_CLASS(HandleKind)														\
    ...
    {																								\
		...
		return rti1516Handle;																		\
																									...
																									\
	HandleKind HandleKind##Friend::createRTI1516Handle(const rti1516e::VariableLengthData & encodedValue)\
    {																								\
...
MessageRetractionHandle MessageRetractionHandleFriend::createRTI1516Handle(const rti1516e::VariableLengthData & encodedValue) {
	MessageRetractionHandle rti1516Handle(encodedValue);														
	return rti1516Handle;	
}
certi::EventRetraction MessageRetractionHandleFriend::createEventRetraction(const rti1516e::MessageRetractionHandle & messageRetractionHandle) {
